            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but SIBS Code could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but SIBS Code still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
