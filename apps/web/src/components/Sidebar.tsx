...
function SibsWordmark() {
  return (
    <svg
      aria-label="SIBS"
      role="img"
      className="h-2.5 w-auto shrink-0 text-foreground"
      viewBox="3.5 3.9 82 24.3"
      fill="currentColor"
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect x="27.4547" y="4.4512" width="5.166" height="23.2469" />
      <path d="M57.0555,11.1529a7.2207,7.2207,0,0,0-7.2708-6.7017h-13.29V27.698h13.29a7.2207,7.2207,0,0,0,7.2708-6.7017,7.081,7.081,0,0,0-1.6126-4.9217A7.081,7.081,0,0,0,57.0555,11.1529ZM41.6611,9.6171h8.3022a1.9373,1.9373,0,1,1,0,3.8745H41.6611Zm0,12.915V18.6576h8.3022a1.9373,1.9373,0,1,1,0,3.8745Z" />
      <path d="M77.309,19.7568,66.0372,9.6172H76.4766l2.398-5.166H64.0224a4.52,4.52,0,0,0-4.52,4.52,4.5181,4.5181,0,0,0,1.4436,3.3135L72.3282,22.5321H60.7012l-2.398,5.166H74.3544a4.5187,4.5187,0,0,0,4.52-4.52,4.5654,4.5654,0,0,0-.0459-.6458A4.5138,4.5138,0,0,0,77.309,19.7568Z" />
      <path d="M83.9827,24.0532a1.94,1.94,0,0,1,.7128.7088,1.9021,1.9021,0,0,1,.2618.9787,1.9532,1.9532,0,1,1-3.9064,0,1.9,1.9,0,0,1,.2618-.9787,1.9583,1.9583,0,0,1,1.6955-.9706A1.909,1.909,0,0,1,83.9827,24.0532Zm-1.7277.3946a1.4765,1.4765,0,0,0-.5436.54,1.4577,1.4577,0,0,0-.2014.7532,1.4421,1.4421,0,0,0,.2014.7451,1.5045,1.5045,0,0,0,.5436.5436,1.4577,1.4577,0,0,0,.7532.2014,1.4429,1.4429,0,0,0,.745-.2014,1.5068,1.5068,0,0,0,.5436-.5436,1.444,1.444,0,0,0,.2014-.7451,1.46,1.46,0,0,0-.2014-.7532,1.508,1.508,0,0,0-2.0418-.54Zm.9384.3344a.607.607,0,0,1,.447.1812.598.598,0,0,1,.1812.439.5869.5869,0,0,1-.0925.3222.69.69,0,0,1-.2538.2335l.3463.7088H83.419l-.3142-.6443H82.702v.6443h-.3543V24.7822Zm-.4914.9021h.4832a.2581.2581,0,0,0,.1935-.0846.2773.2773,0,0,0,.08-.1973.2612.2612,0,0,0-.0884-.2014.2744.2744,0,0,0-.1855-.0806H82.702Z" />
      <path d="M24.3278,21.8181a4.523,4.523,0,0,0-1.3539-2.0613L12.4957,10.3311H5.377a4.5253,4.5253,0,0,0,1.2337,1.9537L17.2,21.8181h7.1278Z" />
      <path d="M17.5153,23.0627l-.5893-.5306H6.3661L3.9681,27.698H20.0193a4.5,4.5,0,0,0,1.9953-.4667v-.118Z" />
      <path d="M12.77,9.6171h9.372L24.54,4.4512H9.6873a4.4956,4.4956,0,0,0-2.0905.5124L12.18,9.0864Z" />
      <path d="M5.1671,8.9714a4.5651,4.5651,0,0,0,.0459.6457h6.489L6.9694,5.36A4.5117,4.5117,0,0,0,5.1671,8.9714Z" />
      <path d="M22.7285,26.7969a4.5171,4.5171,0,0,0,1.811-3.6191,4.5651,4.5651,0,0,0-.0459-.6457H17.993l4.7355,4.2633Z" />
    </svg>
  );
}
