  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new SIBS Code prerelease is available for nightly testers."
          : "A new SIBS Code latest release is available.",
...
).pipe(Command.withDescription("Post a SIBS Code release announcement to Discord."));
